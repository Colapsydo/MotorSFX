...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("Colapsydo", "motorSFX", "com.game.motorSFX", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("com.game.Main");
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (com.game.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (com.game.Main, Reflect.field (com.game.Main, "main"), []);
...
@:keep class DocumentClass extends com.game.Main { }
